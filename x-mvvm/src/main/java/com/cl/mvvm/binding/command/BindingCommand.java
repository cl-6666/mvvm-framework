...
public class BindingCommand<T> {
    ...
    private BindingActionT<T> consumer;
     ...
     */
    public BindingCommand(BindingActionT<T> execute) {
     ...
     * @param canExecute0 true则执行,反之不执行
     */
    public BindingCommand(BindingActionT<T> execute, BindingFunction<Boolean> canExecute0) {
        this.consumer = execute;
        this.canExecute0 = canExecute0;
    }
